...
ALTER TABLE student add address DECIMAL(4.2);
...
INSERT INTO employee (emp_id, first_name, last_name, salary, sex) VALUES(130, 'David', 'Wallace',  260000, 'M');

UPDATE employee
SET branch_id = 1, super_id = 130
WHERE emp_id = 100;
...
INSERT INTO employee VALUES(150, 'Michael', 'Scott', '1964-03-15', 'M', 75000, 100, 2);
...
INSERT INTO employee VALUES(156, 'Stanley', 'Hudson', '1958-02-19', 'M', 69000, 102, 2);
...
INSERT INTO branch VALUES(0, 'Barnawa', 150, '1998-02-13');
...
INSERT INTO branch_supplier VALUES(0, 'Hammer Mill', 'Paper');
